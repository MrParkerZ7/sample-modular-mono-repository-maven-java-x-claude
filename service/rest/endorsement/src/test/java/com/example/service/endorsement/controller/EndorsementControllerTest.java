...
class EndorsementControllerTest {
  ...
  void testApproveEndorsement() throws Exception {
    ...
    mockMvc
        .perform(post("/api/endorsements/end-123/approve"))
        .andExpect(status().isOk())
  ...
  void testApproveEndorsementNotFound() throws Exception {
    ...
    mockMvc
        .perform(post("/api/endorsements/non-existent/approve"))
        .andExpect(status().isNotFound());
  }
  ...
  void testRejectEndorsement() throws Exception {
    ...
    mockMvc
        .perform(post("/api/endorsements/end-123/reject").param("reason", "Policy expired"))
        .andExpect(status().isOk())
  ...
  void testRejectEndorsementNotFound() throws Exception {
    ...
    mockMvc
        .perform(post("/api/endorsements/non-existent/reject").param("reason", "reason"))
        .andExpect(status().isNotFound());
  }
  ...
  void testApplyEndorsement() throws Exception {
    ...
    mockMvc
        .perform(post("/api/endorsements/end-123/apply"))
        .andExpect(status().isOk())
  ...
  void testApplyEndorsementNotFound() throws Exception {
    ...
    mockMvc.perform(post("/api/endorsements/non-existent/apply")).andExpect(status().isNotFound());
  }
  ...
  void testDeleteEndorsement() throws Exception {
    ...
    mockMvc.perform(delete("/api/endorsements/end-123")).andExpect(status().isNoContent());
  }
  ...
  void testDeleteEndorsementNotFound() throws Exception {
    ...
    mockMvc.perform(delete("/api/endorsements/non-existent")).andExpect(status().isNotFound());
  }
}
