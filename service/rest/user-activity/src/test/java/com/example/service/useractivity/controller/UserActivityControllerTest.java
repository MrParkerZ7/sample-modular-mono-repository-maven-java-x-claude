...
class UserActivityControllerTest {
  ...
  void testDeleteActivity() throws Exception {
    ...
    mockMvc.perform(delete("/api/activities/activity-123")).andExpect(status().isNoContent());
  }
  ...
  void testDeleteActivityNotFound() throws Exception {
    ...
    mockMvc.perform(delete("/api/activities/non-existent")).andExpect(status().isNotFound());
  }
}
